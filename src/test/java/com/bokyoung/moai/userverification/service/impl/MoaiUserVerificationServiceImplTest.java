...
//
//        // Act
//        List<MoaiUserVerificationResponseDto> result = moaiUserVerificationService.getUserVerificationCountByAll(requestDto);
//
//        // Assert
//        assertEquals(LocalDate.parse("2024-07-20"), result.get(0).getDate());
//        assertEquals(5L, result.get(0).getCount());
//        assertEquals(LocalDate.parse("2024-07-21"), result.get(1).getDate());
